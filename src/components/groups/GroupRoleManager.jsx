...
const GroupRoleManager = ({ groupId, onClose }) => {
      ...
      try {
        ...
        const enrichedMembers = membersData
          ...
          .sort((a, b) => {
            ...
            const aName =
              a.userData.displayName || a.userData.email || "Unknown";
            const bName =
              b.userData.displayName || b.userData.email || "Unknown";
  ...
  const nonMembers = allUsers.filter(
    (u) => !members.some((m) => m.id === u.id) && u.id !== user?.uid
  );
